# 🛡️ ApniSec: Cyber-Issue-Portal Documentation

## 🏗️ Backend OOP Architecture

The backend follows a strict **Object-Oriented Programming (OOP)** structure as mandated by the assignment. The logic is divided into distinct layers to ensure separation of concerns, testability, and maintainability.
...
_Created for the SDE Intern Assignment By Rohan Parmar_
